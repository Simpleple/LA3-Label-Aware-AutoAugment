...
class ImageNet(torchvision.datasets.ImageFolder):
    ...
    def __init__(self, root, split='train', download=False, **kwargs):
        ...
        devkit_folder = root + '/tmp/ILSVRC2012_devkit_t12'


        
        meta = parse_devkit(devkit_folder)
    ...
    @property
    def meta_file(self):
        return os.path.join(self.root, 'meta.mat')
    ...
    def split_folder(self):
        if self.split == 'train':
            return os.path.join(self.root, 'train_2')
